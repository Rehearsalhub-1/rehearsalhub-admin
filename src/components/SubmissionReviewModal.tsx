  ...
  return (
    <Modal visible={visible} animationType="slide" presentationStyle="pageSheet" onRequestClose={onClose}>
      <SafeAreaView style={styles.container} edges={['top']}>
        ...
        {/* ── 4 TABS: CHAT | LYRICS | SOLFAS | NOTES ─────────────────────────── */}
        ...
        <KeyboardAvoidingView
          ...
          style={{ flex: 1 }}
        >
          {/* TAB 1: CONVERSATION STREAM & REVIEW COMMENTS */}
          {activeTab === 'chat' && (
            <View style={{ flex: 1 }}>
              <ScrollView
                ref={chatScrollRef}
              ...
              >
                {(!song.conversation || song.conversation.length === 0) ? (
              ...
              {/* Quick Feedback Chips Scroll (Web Admin Parity) */}
