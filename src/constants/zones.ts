...
export const ZONES: Zone[] = [
  ...
  { id: 'zone-president-2', name: 'The President 2 Zone', slug: 'president-2-zone', region: 'Headquarters', invitationCode: 'ZONEPRES2', themeColor: '#9333EA' },
  ...
  { id: 'zone-sa-1', name: 'SA-1 President Audit Zone', slug: 'sa-1-president-audit', region: 'Headquarters', invitationCode: 'ZONESA1', themeColor: '#9333EA' },
