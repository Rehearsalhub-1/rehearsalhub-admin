  ...
  async function handleClone(masterSong: MasterSong) {
    ...
    try {
      ...
      const clonedSong: PraiseSong = {
        ...
        leadKeyboardist: masterSong.leadKeyboardist || (masterSong as any).lead_keyboardist || '',
        leadGuitarist: masterSong.leadGuitarist || (masterSong as any).lead_guitarist || '',
        bassGuitarist: masterSong.bassGuitarist || (masterSong as any).bass_guitarist || (masterSong as any).bass || '',
